...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isOnline()) {
            webView.loadUrl("https://appify-your-website.vercel.app/");
        } else {
            loadOfflinePage();
        }
    }
    ...
    private void setupWebViewSettings() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " App converterApp/1.0");
    }
    ...
    private void launchFileChooser() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            try {
                ...
                cameraImageUri = androidx.core.content.FileProvider.getUriForFile(this, "com.app.appconverter.fileprovider", photoFile);
